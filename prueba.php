...
<div style="padding-top: 60px;">
    ...
    <div class="form-group" >
                ...
                <input type="Precio" name="Precio" id="exampleInputPassword1" placeholder="Precio">
                    ...
                    <!-- <a href="balones.php" class="get-started-btn scrollto">Ver todo</a>  -->
                    <a href="javascript:history.back()" class="get-started-btn scrollto">Ver todo</a> 
    </div >
    </form>
</div>
